...
namespace Scada.Comm.Devices
{
    ...
    /// </summary>
    public sealed class KpExSmsView : KPView
    {
        /// <summary>
        ...
        public override KPCnlPrototypes DefaultCnls
        {
            get
            {
                ...
                inCnls.Add(new InCnlPrototype(Localization.UseRussian ? "Данные строки" : "String data",
                    BaseValues.CnlTypes.TI)
                {
                    Signal = 3,
                    ParamName = Localization.UseRussian ? "Данные" : "Data",
                });

                inCnls.Add(new InCnlPrototype(Localization.UseRussian ? "Номер тел." : "Phone num",
                    BaseValues.CnlTypes.TI)
                {
                    Signal = 4,
                    ParamName = Localization.UseRussian ? "Номер тел." : "Phone num",
                });
